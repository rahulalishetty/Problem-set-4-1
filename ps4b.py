...
#
def compPlayHand(hand, wordList, n,tos):
    """
    ...
    while calculateHandlen(hand)>0: 
        # Display the hand
        print(hand)
        print("current hand: len:", calculateHandlen(hand))
        displayHand(hand)
        # Ask user for input
...
def playGame(wordList):
    ...
    while flag:
    	...
    	if choice=='u':
    		if inp=='n':
    			his=playHand(dealHand(HAND_SIZE), wordList, HAND_SIZE,inp)
    		elif inp=='r':
    			his=playHand(his[0], wordList, HAND_SIZE,inp)
    		else:
    			print("input valid input")
    	elif choice=='c':
    		if inp=='r':
    			his=compPlayHand(his[0], wordList, HAND_SIZE,his[1])
    		elif inp=='n':
    			his=compPlayHand(dealHand(HAND_SIZE), wordList, HAND_SIZE, 0)
    	else:
